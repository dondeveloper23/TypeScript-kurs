...
/* harmony export */ });
/* harmony import */ var _handlers_searchMealButtonHandler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../handlers/searchMealButtonHandler */ "./src/handlers/searchMealButtonHandler.ts");

function hookSelectEvents() {
    const searchMeals = document.getElementById("searchMeals");
    searchMeals.addEventListener("click", _handlers_searchMealButtonHandler__WEBPACK_IMPORTED_MODULE_0__.searchMealHandler);
}


/***/ },

/***/ "./src/handlers/searchMealButtonHandler.ts"
/*!*************************************************!*\
  !*** ./src/handlers/searchMealButtonHandler.ts ***!
  \*************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   searchMealHandler: () => (/* binding */ searchMealHandler)
/* harmony export */ });
/* harmony import */ var _services_mealDbService__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/mealDbService */ "./src/services/mealDbService.ts");

async function searchMealHandler() {
    ...
    const response = await (0,_services_mealDbService__WEBPACK_IMPORTED_MODULE_0__.getMealsByCategory)({ data: { param: 'c', value: categorySelect.value } });
    const responseArea = await (0,_services_mealDbService__WEBPACK_IMPORTED_MODULE_0__.getMealsByCategory)({ data: { param: 'a', value: areaSelect.value } });
    const responseIngredients = (0,_services_mealDbService__WEBPACK_IMPORTED_MODULE_0__.getMealByIngredients)(selectedIngredients);
...
/***/ "./src/helpers/htmlSelectHelper.ts"
/*!*****************************************!*\
  !*** ./src/helpers/htmlSelectHelper.ts ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fillSelectWithOptions: () => (/* binding */ fillSelectWithOptions)
/* harmony export */ });
function fillSelectWithOptions(elementId, data) {
...
function buildValueAndTextBasedOnType(option) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   showMeal: () => (/* binding */ showMeal)
/* harmony export */ });
function showMeal(parent, data) {
...
/* harmony export */   getMealByIngredients: () => (/* binding */ getMealByIngredients),
/* harmony export */   getMealCategories: () => (/* binding */ getMealCategories),
/* harmony export */   getMealsByCategory: () => (/* binding */ getMealsByCategory),
/* harmony export */   getRandomMeals: () => (/* binding */ getRandomMeals),
/* harmony export */   searchMeal: () => (/* binding */ searchMeal)
/* harmony export */ });
...
async function getMealsByCategory(data) {
...
/* harmony import */ var _services_mealDbService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./services/mealDbService */ "./src/services/mealDbService.ts");
/* harmony import */ var _helpers_htmlSelectHelper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/htmlSelectHelper */ "./src/helpers/htmlSelectHelper.ts");
/* harmony import */ var _helpers_showMealHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/showMealHelper */ "./src/helpers/showMealHelper.ts");
...
async function main() {
    ...
    const categories = await (0,_services_mealDbService__WEBPACK_IMPORTED_MODULE_1__.getMealCategories)({ data: { param: 'c', value: 'list' } });
    const ingredients = await (0,_services_mealDbService__WEBPACK_IMPORTED_MODULE_1__.getMealCategories)({ data: { param: 'i', value: 'list' } });
    const areas = await (0,_services_mealDbService__WEBPACK_IMPORTED_MODULE_1__.getMealCategories)({ data: { param: 'a', value: 'list' } });
    (0,_helpers_htmlSelectHelper__WEBPACK_IMPORTED_MODULE_2__.fillSelectWithOptions)("categorySelect", categories);
    (0,_helpers_htmlSelectHelper__WEBPACK_IMPORTED_MODULE_2__.fillSelectWithOptions)("ingredientSelect", ingredients);
    (0,_helpers_htmlSelectHelper__WEBPACK_IMPORTED_MODULE_2__.fillSelectWithOptions)("areaSelect", areas);
    const randomMeals = await (0,_services_mealDbService__WEBPACK_IMPORTED_MODULE_1__.getRandomMeals)(3);
    console.log(randomMeals);
    (0,_helpers_showMealHelper__WEBPACK_IMPORTED_MODULE_3__.showMeal)("randomMeals", randomMeals);
}
main();
