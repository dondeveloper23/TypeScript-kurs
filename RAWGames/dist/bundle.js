...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   userEvents: () => (/* binding */ userEvents)
/* harmony export */ });
/* harmony import */ var _handlers_searchGames__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../handlers/searchGames */ "./src/handlers/searchGames.ts");
/* harmony import */ var _handlers_saveSearch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../handlers/saveSearch */ "./src/handlers/saveSearch.ts");


async function userEvents() {
    const searchButton = document.getElementById('search-button');
    const saveSearchButton = document.getElementById('save-search-button');
    searchButton.addEventListener('click', _handlers_searchGames__WEBPACK_IMPORTED_MODULE_0__.searchGames);
    saveSearchButton.addEventListener("click", _handlers_saveSearch__WEBPACK_IMPORTED_MODULE_1__.saveSearch);
}


/***/ },

/***/ "./src/handlers/saveSearch.ts"
/*!************************************!*\
  !*** ./src/handlers/saveSearch.ts ***!
  \************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   saveSearch: () => (/* binding */ saveSearch)
/* harmony export */ });
/* harmony import */ var _helpers_appendSavedSearchHtml__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/appendSavedSearchHtml */ "./src/helpers/appendSavedSearchHtml.ts");

function saveSearch() {
    const savedSearches = JSON.parse(localStorage.getItem("searches") || "[]");
    const searchInput = document.getElementById('search-name');
    const genreSelect = document.getElementById('genre-select');
    const savedSearchDiv = document.getElementById('saved-searches-div');
    ...
    (0,_helpers_appendSavedSearchHtml__WEBPACK_IMPORTED_MODULE_0__.appendSavedSearch)(savedSearchDiv, currentSearchTerm, String(genreSelect.value), selectedGenre);
}
function isDuplicate(arr, search, genre) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   searchGames: () => (/* binding */ searchGames)
/* harmony export */ });
/* harmony import */ var _services_rawApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/rawApi */ "./src/services/rawApi.ts");
/* harmony import */ var _helpers_appendGamesHtml__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/appendGamesHtml */ "./src/helpers/appendGamesHtml.ts");


async function searchGames() {
    const searchInput = document.getElementById('search-name');
    const genreSelect = document.getElementById('genre-select');
    let games = await (0,_services_rawApi__WEBPACK_IMPORTED_MODULE_0__.callApiGames)({ search: searchInput.value, genres: genreSelect.value });
    (0,_helpers_appendGamesHtml__WEBPACK_IMPORTED_MODULE_1__.appendGamesHtml)(games);
}


/***/ },

/***/ "./src/helpers/appendCategoriesHtml.ts"
/*!*********************************************!*\
  !*** ./src/helpers/appendCategoriesHtml.ts ***!
  \*********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   appendCategoriesHtml: () => (/* binding */ appendCategoriesHtml)
/* harmony export */ });
/* harmony import */ var _services_rawApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/rawApi */ "./src/services/rawApi.ts");

async function appendCategoriesHtml() {
    const genreSelect = document.getElementById('genre-select');
    const genres = await (0,_services_rawApi__WEBPACK_IMPORTED_MODULE_0__.callApiCategory)({});
...
/***/ "./src/helpers/appendGameDetails.ts"
/*!******************************************!*\
  !*** ./src/helpers/appendGameDetails.ts ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   appendGameDetails: () => (/* binding */ appendGameDetails)
/* harmony export */ });
function appendGameDetails(game, element) {
...
/***/ "./src/helpers/appendGamesHtml.ts"
/*!****************************************!*\
  !*** ./src/helpers/appendGamesHtml.ts ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   appendGamesHtml: () => (/* binding */ appendGamesHtml)
/* harmony export */ });
function appendGamesHtml(games) {
...
/***/ "./src/helpers/appendSavedSearchHtml.ts"
/*!**********************************************!*\
  !*** ./src/helpers/appendSavedSearchHtml.ts ***!
  \**********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   appendSavedSearch: () => (/* binding */ appendSavedSearch)
/* harmony export */ });
/* harmony import */ var _services_rawApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/rawApi */ "./src/services/rawApi.ts");
/* harmony import */ var _appendGamesHtml__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./appendGamesHtml */ "./src/helpers/appendGamesHtml.ts");


function appendSavedSearch(element, searchText, searchGenreID, genreName) {
    ...
    searchBtn.onclick = async () => {
        const games = await (0,_services_rawApi__WEBPACK_IMPORTED_MODULE_0__.callApiGames)({ search: searchText, genres: searchGenreID });
        (0,_appendGamesHtml__WEBPACK_IMPORTED_MODULE_1__.appendGamesHtml)(games);
    };
    deleteBtn.onclick = () => {
        const savedSearches = JSON.parse(localStorage.getItem("searches") || "[]");
...
/***/ "./src/helpers/initSavedSearches.ts"
/*!******************************************!*\
  !*** ./src/helpers/initSavedSearches.ts ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initSavedSearches: () => (/* binding */ initSavedSearches)
/* harmony export */ });
/* harmony import */ var _appendSavedSearchHtml__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./appendSavedSearchHtml */ "./src/helpers/appendSavedSearchHtml.ts");

function initSavedSearches() {
    const savedSearches = JSON.parse(localStorage.getItem("searches") || "[]");
    const savedSearchDiv = document.getElementById('saved-searches-div');
    savedSearches.forEach((search) => {
        (0,_appendSavedSearchHtml__WEBPACK_IMPORTED_MODULE_0__.appendSavedSearch)(savedSearchDiv, search.search, search.genres, search.genreName);
    });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _services_rawApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/rawApi */ "./src/services/rawApi.ts");
/* harmony import */ var _helpers_appendCategoriesHtml__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/appendCategoriesHtml */ "./src/helpers/appendCategoriesHtml.ts");
/* harmony import */ var _events_events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./events/events */ "./src/events/events.ts");
/* harmony import */ var _pages_gamedetails__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/gamedetails */ "./src/pages/gamedetails.ts");
/* harmony import */ var _helpers_initSavedSearches__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers/initSavedSearches */ "./src/helpers/initSavedSearches.ts");
...
if (window.location.href.includes("gamedetails.html")) {
    await (0,_pages_gamedetails__WEBPACK_IMPORTED_MODULE_3__.initGameDetails)();
}
else {
    await init();
    (0,_helpers_initSavedSearches__WEBPACK_IMPORTED_MODULE_4__.initSavedSearches)();
}
async function init() {
    await (0,_helpers_appendCategoriesHtml__WEBPACK_IMPORTED_MODULE_1__.appendCategoriesHtml)();
    await (0,_events_events__WEBPACK_IMPORTED_MODULE_2__.userEvents)();
    const test = await (0,_services_rawApi__WEBPACK_IMPORTED_MODULE_0__.callApiGames)({ search: "fortnite" });
    console.log(test);
}
...
/* harmony export */ });
/* harmony import */ var _services_rawApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/rawApi */ "./src/services/rawApi.ts");
/* harmony import */ var _helpers_appendGameDetails__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/appendGameDetails */ "./src/helpers/appendGameDetails.ts");
...
async function initGameDetails() {
    ...
    const game = await (0,_services_rawApi__WEBPACK_IMPORTED_MODULE_0__.callApiGame)(String(id));
    (0,_helpers_appendGameDetails__WEBPACK_IMPORTED_MODULE_1__.appendGameDetails)(game, gameDetails);
}


/***/ },

/***/ "./src/services/buildUrl.ts"
/*!**********************************!*\
  !*** ./src/services/buildUrl.ts ***!
  \**********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const API_KEY = "48e17a58850f4567996cccb395ab603b";
function buildUrl(category, searchQuery) {
    let url = API_BASE + category + "?key=" + API_KEY;
    if (searchQuery) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   callApiCategory: () => (/* binding */ callApiCategory),
/* harmony export */   callApiGame: () => (/* binding */ callApiGame),
/* harmony export */   callApiGames: () => (/* binding */ callApiGames)
/* harmony export */ });
/* harmony import */ var _buildUrl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./buildUrl */ "./src/services/buildUrl.ts");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! axios */ "./node_modules/axios/lib/axios.js");


async function callApiGames(searchQuery) {
    let url = (0,_buildUrl__WEBPACK_IMPORTED_MODULE_0__.buildUrl)("games", searchQuery);
    const response = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(url);
    return response.data.results;
}
async function callApiGame(id) {
    let url = (0,_buildUrl__WEBPACK_IMPORTED_MODULE_0__.buildUrl)(`games/${id}`);
    const response = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(url);
    return response.data;
}
async function callApiCategory(searchQuery) {
    let url = (0,_buildUrl__WEBPACK_IMPORTED_MODULE_0__.buildUrl)("genres", searchQuery);
    const response = await axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(url);
    return response.data.results;
}
